...
public class UIUtil {
    ...
    public static int dip2px(float dpValue) {
        return (int) (TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, dpValue,
                BaseApplication.getInstance().getResources().getDisplayMetrics()) + 0.5f);
    }
    ...
    public static Spanned setTextColorSpan(int color, String beforeText, String behindText) {
        String textColorSpan = "<font color='" + color + "'>" + beforeText + "</font>" + " "
                + behindText;
    ...
    public static int getScreenHeightWithoutBar() {
        return getScreenHeight()
                - (int) BaseApplication.getInstance().getResources()
                        .getDimension(R.dimen.tab_layout_height)
                - (int) BaseApplication.getInstance().getResources()
    ...
    public static int getScreenHeightWithoutTitleBar() {
        return getScreenHeight() - (int) BaseApplication.getInstance().getResources()
                .getDimension(R.dimen.titlebar_height) - getStatusBarHeight();
    }
    ...
    public static int getStatusBarAndTitleHeight() {
        Resources resources = BaseApplication.getInstance().getResources();
        int resourceId = resources.getIdentifier("status_bar_height", "dimen", "android");
        int height = resources.getDimensionPixelSize(resourceId) + (int) BaseApplication
                .getInstance().getResources().getDimension(R.dimen.titlebar_height);
        return height;
    }
