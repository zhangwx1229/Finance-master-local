...
public class PermissionUtils {
     ...
     */
    public static PermissionUtils permission(Context context, @PermissionConstants
    ...
    private PermissionUtils(final String... permissions) {
        ...
        for (String permission : permissions) {
            for (String permis : PermissionConstants.getPermissions(permission)) {
                if (PERMISSIONS.contains(permis)) {
                    mPermissions.add(permis);
                }
            }
        }
        sInstance = this;
