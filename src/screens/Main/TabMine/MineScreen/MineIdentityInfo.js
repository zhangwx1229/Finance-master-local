...
export default class MineIdentityInfo extends PureComponent {
    ...
    render() {
        ...
        const image_h = scre_w * 405 / 818
        const top = (UI.size.screenHeight - image_top - image_bottom - image_h) / 2

        return (<View style={styles.container} >
            <Image style={{ position: 'absolute', width: UI.size.screenWidth, height: image_top }} source={Images.icon_10} />
            <TouchableWithoutFeedback onPress={this.back}>
                <View style={{ marginLeft: 5, width: 50, height: 40 }} />
            </TouchableWithoutFeedback>
            <Image style={{ position: 'absolute', left: 40, top: top, width: scre_w, height: image_h }} source={Images.icon_9} />
