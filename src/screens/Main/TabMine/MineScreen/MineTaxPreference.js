...
export default class MineTaxPreference extends PureComponent {
    ...
    render() {
        ...
        return (<View style={styles.container} >
            <Image style={{ position: 'absolute', width: UI.size.screenWidth, height: UI.size.screenWidth * 130 / 1080 }} source={Images.icon_6} />
            <TouchableWithoutFeedback onPress={this.back}>
                <View style={{ marginLeft: 5, width: 50, height: 40 }} />
            </TouchableWithoutFeedback>
            <Image style={{ position: 'absolute', left: 40, top: (UI.size.screenHeight - scre_w * 494 / 818 - 100) / 2, width: scre_w, height: scre_w * 494 / 818 }} source={Images.icon_7} />
